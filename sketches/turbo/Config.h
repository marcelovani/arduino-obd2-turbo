...
#define TRACK_SPRAY_DEFAULT  5 // default spray        — all gear changes
#define TRACK_SPRAY_GEAR1    5 // alternative: longer  — 1st→2nd gear change
#define TRACK_SPRAY_GEAR2    5 // alternative: shorter — 2nd→3rd gear change
#define TRACK_SPRAY_GEAR3    5 // (same as default)    — 3rd→4th gear change
