...
SCENARIOS: dict[str, Scenario] = {
    ...
    # Turbo #1 at ~1500ms (1st→2nd).
    # Turbo #2 at ~3600ms (2nd→3rd) — must be >2000ms after Turbo #1 for cooldown.
    # No Turbo in 3rd gear (gear > max_gear).
    "first_gear_change": [
        (0,     0,   800,  0),    # idle
        ...
        (1500,  4,  3300, 28),    # *** Turbo #1 *** (ratio 118 → gear 2, rpm 3300 > 1500)
        ...
        (3600,  4,  3300, 46),    # *** Turbo #2 *** (2100ms after Turbo#1, ratio 72 → gear 2)
        (3700, 40,  2000, 50),    # into 3rd
        (4000, 60,  2800, 58),    # 3rd gear (ratio 48 → gear 3) — no Turbo
        (4300,  4,  2600, 61),    # lift in 3rd — no Turbo (gear 3 > max_gear 2)
    ],
    ...
    "second_gear_hard_pull": [
        ...
        (1500,  4, 3400, 47),     # *** LIFT OFF → Turbo expected ***
        (1800, 50, 2500, 52),
    ],
    ...
    # Throttle drops slowly — prev_TPS never stays aturboe threshold long
    ...
    "no_turbo_gradual_release": [
        ...
        (600,  40,  2600, 24),    # at threshold, not aturboe
    ...
    "no_turbo_high_gear": [
        ...
        (800,  80, 3200,  68),
        (1200,  4, 3000,  72),    # lift off in 3rd — no Turbo
    ],
    ...
    "cooldown_test": [
        (0,    0,   800,  0),
        (400,  75,  3200, 22),
        (800,   4,  3000, 25),    # *** Turbo #1 ***
        (900,  70,  2500, 28),    # immediately back on throttle
        (1200,  4,  2400, 30),    # within 2s cooldown — NO Turbo
        (2900, 75,  3100, 35),    # cooldown expired (>2s since Turbo #1)
        (3300,  4,  2900, 38),    # *** Turbo #2 ***
    ],
}
